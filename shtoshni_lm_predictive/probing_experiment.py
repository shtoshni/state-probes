...
from data_transformer import convert_to_transformer_batches_probing
...
def probing_exp(model_path: str, base_dir: str):
	...
	output = {}
	for j, (inputs, lang_tgts, raw_state_targets) in enumerate(
					convert_to_transformer_batches_probing(
						dev_dataset, tokenizer, 1, domain="alchemy", device=device)):
